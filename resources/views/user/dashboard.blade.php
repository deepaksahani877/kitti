                ...
                <div class="border-t border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
                        <div class="text-center">
                            <div class="text-3xl font-bold text-green-600">₹{{ number_format($activeRegistration->plan_amount * 1.2) }}</div>
                        ...
                        <div class="text-center">
                            <div class="text-3xl font-bold text-blue-600">₹{{ number_format($activeRegistration->plan_amount * 0.2) }}</div>
                            <div class="text-sm text-gray-500">Expected Returns</div>
                            <div class="text-xs text-gray-400">20% annual return</div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="space-y-3">
                                ...
                                @for($i = 0; $i < $totalPayments; $i++)
                                    ...
                                    <div class="flex items-center justify-between p-3 {{ $isOverdue ? 'bg-red-50 border border-red-200 rounded' : 'bg-gray-50 border border-gray-200 rounded' }}">
                                        ...
                                        <div class="text-right">
                                            <div class="font-medium text-gray-900">₹{{ number_format($activeRegistration->getPaymentAmount()) }}</div>
                                            @if($isOverdue)
                        ...
                        <div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div class="text-sm text-blue-800 mb-4">
                                    <strong>Next Payment:</strong> ₹{{ number_format($activeRegistration->getPaymentAmount()) }}<br>
